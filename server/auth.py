...
_token_claims_var: contextvars.ContextVar[dict[str, Any] | None] = contextvars.ContextVar(
    "token_claims",
    default=None,
)


def set_token_claims(claims: dict[str, Any]) -> contextvars.Token[dict[str, Any] | None]:
...
class EntraTokenValidator:
    ...
    def validate_token(self, token: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise AuthError("Bearer token audience did not match this resource.") from exc
