...
echo "  2. Run repro test: uv run client/test_client.py repro --server-url https://$NEW_APP.azurewebsites.net"
echo "  3. Run fix test:   uv run client/test_client.py fixed --server-url https://$NEW_APP-$SLOT.azurewebsites.net"
